...
# virtual methods
.method public final a(Lgzc;Lgzo;Lgzu;Lgzx;Lgyz;Lgyw;Lhaa;Lgzf;Lgzl;Lgzr;Lhad;Z)Lcom/google/android/apps/youtube/embeddedplayer/service/service/jar/IApiPlayerService;
    .locals 5
    ...
    invoke-interface {p1}, Lgzc;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p2}, Lgzo;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p3}, Lgzu;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p4}, Lgzx;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p5}, Lgyz;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p6}, Lgyw;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p7}, Lhaa;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p8}, Lgzf;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p9}, Lgzl;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface {p10}, Lgzr;->asBinder()Landroid/os/IBinder;
    ...
    invoke-interface/range {p11 .. p11}, Lhad;->asBinder()Landroid/os/IBinder;
