...
.method public static loadNativeGvrLibrary(Landroid/content/Context;III)J
    ...
    invoke-direct {v0, v1}, Lzob;-><init>(I)V
    ...
    .line 48
    :cond_2
    invoke-static {p0}, Lzpq;->a(Landroid/content/Context;)Landroid/content/Context;

    move-result-object v4

    .line 2050
    sget-object v0, Lzpq;->a:Lzpm;
    ...
    invoke-static {v0, v5}, Lzpq;->a(Ljava/lang/ClassLoader;Ljava/lang/String;)Landroid/os/IBinder;
    ...
    .line 52
    invoke-static {v4}, Lcom/google/vr/vrcore/library/api/ObjectWrapper;->a(Ljava/lang/Object;)Lzpk;

    move-result-object v4

    invoke-static {p0}, Lcom/google/vr/vrcore/library/api/ObjectWrapper;->a(Ljava/lang/Object;)Lzpk;

    move-result-object v5

    .line 51
    invoke-interface {v0, v4, v5}, Lzpm;->a(Lzpk;Lzpk;)Lzpo;
    ...
    invoke-direct {v0, v5}, Lzpn;-><init>(Landroid/os/IBinder;)V
    ...
    invoke-interface {v0, v4, v5, v1}, Lzpo;->a(III)J
    :try_end_1
    .catch Lzob; {:try_start_1 .. :try_end_1} :catch_0
