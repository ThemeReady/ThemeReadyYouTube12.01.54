...
.method private static readPhoneParams(Landroid/content/Context;J)V
    ...
    .line 1170
    invoke-static {v0}, Lzly;->a(Landroid/view/Display;)Landroid/util/DisplayMetrics;
    ...
    .line 131
    invoke-interface {v1}, Lznl;->d()V

    .line 132
    if-eqz v2, :cond_2

    .line 133
    invoke-virtual {v2}, Lzqa;->d()Z
...
.method private static readSdkConfigurationParams(Landroid/content/Context;)[B
    ...
    .prologue
    .line 82
    invoke-static {p0}, Lcom/google/vr/ndk/base/SdkConfigurationReader;->getParams(Landroid/content/Context;)Lzip;
...
.method private static readUserPrefs(Landroid/content/Context;)[B
    ...
    .line 153
    invoke-interface {v0}, Lznl;->c()Lzqc;
...
.method private static writeDeviceParams(Landroid/content/Context;[B)Z
    ...
    .line 100
    :goto_0
    invoke-interface {v1, v0}, Lznl;->a(Lzpx;)Z
    :try_end_0
