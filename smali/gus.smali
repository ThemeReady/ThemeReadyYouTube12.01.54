...
# direct methods
.method public constructor <init>(Landroid/view/View;Lguf;Lgvk;)V
    .locals 6
    ...
    .line 137
    invoke-direct/range {v0 .. v5}, Lgus;-><init>(Landroid/view/View;Lguf;Lgvk;Landroid/os/Looper;Ljava/util/Random;)V

    .line 150
    return-void
.end method

.method private constructor <init>(Landroid/view/View;Lguf;Lgvk;Landroid/os/Looper;Ljava/util/Random;)V
    .locals 2
    ...
    iput-object v0, p0, Lgus;->n:Landroid/view/View;
    ...
    iput-object v0, p0, Lgus;->b:Ljava/util/Random;

    .line 117
    iput-boolean v1, p0, Lgus;->p:Z

    .line 118
    iput-boolean v1, p0, Lgus;->q:Z

    .line 119
    iput-boolean v1, p0, Lgus;->r:Z

    .line 120
    const-string v0, "normalMinimumPeriod must be >= 0"

    invoke-static {v1, v0}, Lmjz;->a(ZLjava/lang/Object;)V
    ...
    iput-object v0, p0, Lgus;->g:Landroid/os/Handler;
    ...
    iput-object v0, p0, Lgus;->s:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Lgus;->t:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Lgus;->u:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Lgus;->v:Landroid/graphics/Rect;
...
.method private final a(Landroid/view/View;)Z
    ...
    .line 299
    iget-object v0, p0, Lgus;->n:Landroid/view/View;

    iget-object v1, p0, Lgus;->s:Landroid/graphics/Rect;

    invoke-static {v0, v1}, Lgus;->a(Landroid/view/View;Landroid/graphics/Rect;)V

    .line 301
    iget-object v2, p0, Lgus;->n:Landroid/view/View;
    ...
    invoke-static {v0, v2, v1}, Lgus;->a(Landroid/view/View;Landroid/view/ViewGroup;Landroid/graphics/Rect;)V

    .line 308
    iget-boolean v1, p0, Lgus;->p:Z

    if-eqz v1, :cond_3

    .line 310
    iget-object v1, p0, Lgus;->t:Landroid/graphics/Rect;
    ...
    iget-object v3, p0, Lgus;->s:Landroid/graphics/Rect;
    ...
    iget-object v2, p0, Lgus;->t:Landroid/graphics/Rect;

    iget-object v3, p0, Lgus;->s:Landroid/graphics/Rect;

    .line 317
    invoke-static {v2, v3}, Lgus;->a(Landroid/graphics/Rect;Landroid/graphics/Rect;)Ljava/lang/String;
    ...
    iput-object v0, p0, Lgus;->k:Ljava/lang/String;
    ...
    .line 329
    iget-object v0, p0, Lgus;->s:Landroid/graphics/Rect;
    ...
    invoke-direct/range {v0 .. v6}, Lgus;->a(Landroid/view/View;Landroid/view/ViewGroup;IIII)Z
...
.method private final a(Landroid/view/View;Landroid/view/ViewGroup;IIII)Z
    ...
    .prologue
    .line 348
    iget-object v4, p0, Lgus;->u:Landroid/graphics/Rect;
    ...
    invoke-static {v0, v1, v4}, Lgus;->a(Landroid/view/View;Landroid/view/ViewGroup;Landroid/graphics/Rect;)V

    .line 351
    iget-object v4, p0, Lgus;->v:Landroid/graphics/Rect;

    move-object/from16 v0, p1

    invoke-static {v0, v4}, Lgus;->a(Landroid/view/View;Landroid/graphics/Rect;)V

    .line 352
    iget-object v4, p0, Lgus;->v:Landroid/graphics/Rect;

    iget-object v5, p0, Lgus;->u:Landroid/graphics/Rect;

    iget v5, v5, Landroid/graphics/Rect;->left:I

    iget-object v6, p0, Lgus;->u:Landroid/graphics/Rect;
    ...
    iget-object v8, p0, Lgus;->u:Landroid/graphics/Rect;

    iget-object v9, p0, Lgus;->v:Landroid/graphics/Rect;
    ...
    .line 4383
    invoke-static {v9, v8}, Lgus;->a(Landroid/graphics/Rect;Landroid/graphics/Rect;)Ljava/lang/String;
    ...
    iput-object v4, p0, Lgus;->k:Ljava/lang/String;
    ...
    .line 4387
    invoke-static {v8, v9}, Lgus;->a(Landroid/graphics/Rect;Landroid/graphics/Rect;)Ljava/lang/String;
    ...
    .line 371
    invoke-direct/range {v4 .. v10}, Lgus;->a(Landroid/view/View;Landroid/view/ViewGroup;IIII)Z
...
.method public final a()V
    ...
    .line 154
    iget-object v0, p0, Lgus;->g:Landroid/os/Handler;
...
.method public final c()Z
    ...
    .line 219
    iget-object v3, p0, Lgus;->n:Landroid/view/View;
    ...
    .line 220
    iget-object v4, p0, Lgus;->n:Landroid/view/View;
    ...
    iput-object v0, p0, Lgus;->l:Ljava/lang/String;
...
.method public final d()Z
    ...
    iput-object v0, p0, Lgus;->m:Ljava/lang/String;
...
.method public final e()Z
    ...
    .line 277
    invoke-direct {p0, v0}, Lgus;->a(Landroid/view/View;)Z
