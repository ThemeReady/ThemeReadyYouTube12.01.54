...
# direct methods
.method constructor <init>(Lmqv;Lmiy;)V
    .locals 1
    ...
    iput-object v0, p0, Lmrg;->b:Lmiy;

    .line 49
    return-void
.end method

.method private static a(Lorg/apache/http/client/methods/HttpEntityEnclosingRequestBase;Laxd;)V
    .locals 2

    .prologue
    .line 165
    invoke-virtual {p1}, Laxd;->o()[B
...
# virtual methods
.method public final a(Laxd;Ljava/util/Map;)Lorg/apache/http/HttpResponse;
    .locals 6
    ...
    .line 1182
    invoke-virtual {p1}, Laxd;->b()Ljava/lang/Object;
    ...
    invoke-virtual {p1}, Laxd;->j()Ljava/lang/String;
    ...
    .line 70
    :goto_2
    invoke-static {v2, p2}, Lmrg;->a(Lorg/apache/http/client/methods/HttpUriRequest;Ljava/util/Map;)V

    .line 71
    invoke-virtual {p1}, Laxd;->g()Ljava/util/Map;

    move-result-object v3

    invoke-static {v2, v3}, Lmrg;->a(Lorg/apache/http/client/methods/HttpUriRequest;Ljava/util/Map;)V
    ...
    .line 3096
    invoke-virtual {v3}, Laxf;->ordinal()I
    ...
    .line 77
    :goto_3
    invoke-static {v4, v3}, Lmqp;->a(Lorg/apache/http/params/HttpParams;I)V

    .line 79
    if-eqz v1, :cond_4

    .line 80
    iget-object v3, p0, Lmrg;->b:Lmiy;

    invoke-virtual {v3, v1}, Lmiy;->d(Ljava/lang/Object;)V

    .line 4091
    :cond_4
    iget-object v1, p0, Lmrg;->a:Lmqv;

    invoke-virtual {v1, v2}, Lmqv;->a(Lorg/apache/http/client/methods/HttpUriRequest;)Lorg/apache/http/HttpResponse;
    ...
    invoke-virtual {p1}, Laxd;->n()Ljava/lang/String;
    ...
    .line 2138
    invoke-static {v2, p1}, Lmrg;->a(Lorg/apache/http/client/methods/HttpEntityEnclosingRequestBase;Laxd;)V
    ...
    invoke-direct {v2, v3}, Laxz;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v3, v4}, Laxz;->addHeader(Ljava/lang/String;Ljava/lang/String;)V
