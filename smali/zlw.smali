...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lzlw;->a:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/ContentProviderClient;Ljava/lang/String;)V
    ...
    .line 53
    :cond_2
    iput-object p1, p0, Lzlw;->b:Landroid/content/ContentProviderClient;

    .line 54
    const-string v0, "device_params"

    .line 55
    invoke-static {p2, v0}, Lzno;->a(Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v0

    iput-object v0, p0, Lzlw;->c:Landroid/net/Uri;
    ...
    iput-object v0, p0, Lzlw;->d:Landroid/net/Uri;
    ...
    iput-object v0, p0, Lzlw;->e:Landroid/net/Uri;
    ...
    iput-object v0, p0, Lzlw;->f:Landroid/net/Uri;

    .line 66
    return-void
.end method

.method private final a(Lzji;Landroid/net/Uri;Ljava/lang/String;)Lzji;
    .locals 7
    ...
    .line 121
    :try_start_0
    iget-object v0, p0, Lzlw;->b:Landroid/content/ContentProviderClient;
    ...
    :try_end_0
    .catch Lzjh; {:try_start_0 .. :try_end_0} :catch_2
    ...
    :try_end_1
    .catch Lzjh; {:try_start_1 .. :try_end_1} :catch_3
    ...
    :try_end_2
    .catch Lzjh; {:try_start_2 .. :try_end_2} :catch_3
    ...
    :cond_3
    :try_start_3
    sget-object v0, Lzlw;->a:Ljava/lang/String;
    ...
    :try_end_3
    .catch Lzjh; {:try_start_3 .. :try_end_3} :catch_3
    ...
    :goto_1
    :try_start_4
    sget-object v2, Lzlw;->a:Ljava/lang/String;
...
.method private final a(Lzji;Landroid/net/Uri;)Z
    .locals 5
    ...
    .line 158
    :try_start_0
    iget-object v1, p0, Lzlw;->b:Landroid/content/ContentProviderClient;
    ...
    .line 163
    iget-object v2, p0, Lzlw;->b:Landroid/content/ContentProviderClient;
...
.method public final a(Lzpt;)Lzip;
    ...
    .line 91
    sget-object v1, Lcom/google/vr/ndk/base/SdkConfigurationReader;->DEFAULT_PARAMS:Lzip;

    iget-object v2, p0, Lzlw;->f:Landroid/net/Uri;

    invoke-direct {p0, v1, v2, v0}, Lzlw;->a(Lzji;Landroid/net/Uri;Ljava/lang/String;)Lzji;
...
.method public final a()Lzpx;
    ...
    iget-object v1, p0, Lzlw;->c:Landroid/net/Uri;

    const/4 v2, 0x0

    invoke-direct {p0, v0, v1, v2}, Lzlw;->a(Lzji;Landroid/net/Uri;Ljava/lang/String;)Lzji;
...
.method public final a(Lzpx;)Z
    ...
    .prologue
    .line 75
    iget-object v0, p0, Lzlw;->c:Landroid/net/Uri;

    invoke-direct {p0, p1, v0}, Lzlw;->a(Lzji;Landroid/net/Uri;)Z
...
.method public final b()Lzqa;
    ...
    iget-object v1, p0, Lzlw;->e:Landroid/net/Uri;
...
.method public final c()Lzqc;
    ...
    iget-object v1, p0, Lzlw;->d:Landroid/net/Uri;
