...
.field private synthetic e:Lfct;
...
.method public constructor <init>(Lfct;Landroid/view/View;)V
    ...
    .prologue
    .line 256
    iput-object p1, p0, Lfcu;->e:Lfct;

    .line 257
    invoke-direct {p0, p1, p2}, Lfcw;-><init>(Lfct;Landroid/view/View;)V
    ...
    iput-object v0, p0, Lfcu;->d:Landroid/widget/TextView;
...
.method public final a(I)Lcws;
    ...
    .line 263
    invoke-super {p0, p1}, Lfcw;->a(I)Lcws;

    .line 265
    iget-object v0, p0, Lfcu;->d:Landroid/widget/TextView;

    if-eqz v0, :cond_0

    .line 266
    iget-object v1, p0, Lfcu;->d:Landroid/widget/TextView;

    iget-object v0, p0, Lfcu;->e:Lfct;
    ...
    .line 269
    :cond_0
    iget-object v0, p0, Lfcu;->a:Landroid/widget/FrameLayout;
    ...
    .line 271
    iget-object v1, p0, Lfcu;->c:Lcws;

    if-ne v0, v1, :cond_1

    .line 272
    iget-object v0, p0, Lfcu;->b:Landroid/widget/RelativeLayout;

    iget-object v1, p0, Lfcu;->e:Lfct;
    ...
    .line 282
    :goto_0
    iget-object v3, p0, Lfcu;->e:Lfct;

    invoke-virtual {v3}, Lfct;->getCount()I
    ...
    .line 284
    :goto_1
    iget-object v3, p0, Lfcu;->a:Landroid/widget/FrameLayout;

    invoke-virtual {v3, v2, v0, v2, v1}, Landroid/widget/FrameLayout;->setPadding(IIII)V

    .line 287
    :cond_2
    iget-object v0, p0, Lfcu;->c:Lcws;
