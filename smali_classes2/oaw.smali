...
.field private b:Lavh;

.field private c:Laux;


# direct methods
.method public constructor <init>(Lavd;Ljava/lang/String;Landroid/view/TextureView;)V
    .locals 1
    ...
    iput v0, p0, Loaw;->mScaleMode:I

    .line 39
    iput-object p3, p0, Loaw;->a:Landroid/view/TextureView;
...
.method protected final onProcess()V
    ...
    invoke-virtual {p0, v0}, Loaw;->getConnectedInputPort(Ljava/lang/String;)Lava;
    ...
    .line 1056
    iget-object v1, p0, Loaw;->a:Landroid/view/TextureView;
    ...
    iget-object v2, p0, Loaw;->a:Landroid/view/TextureView;

    invoke-virtual {v2}, Landroid/view/TextureView;->getSurfaceTexture()Landroid/graphics/SurfaceTexture;

    move-result-object v2

    invoke-virtual {v1, v2}, Lavh;->a(Landroid/graphics/SurfaceTexture;)Lavh;

    move-result-object v1

    iput-object v1, p0, Loaw;->b:Lavh;
    ...
    iget-object v3, p0, Loaw;->a:Landroid/view/TextureView;

    invoke-virtual {v3}, Landroid/view/TextureView;->getWidth()I

    move-result v3

    iget-object v4, p0, Loaw;->a:Landroid/view/TextureView;
    ...
    .line 70
    iget-object v3, p0, Loaw;->c:Laux;

    invoke-virtual {p0, v3, v1, v2}, Loaw;->setupShader(Laux;Landroid/graphics/Rect;Landroid/graphics/Rect;)V

    .line 71
    iget-object v1, p0, Loaw;->c:Laux;

    invoke-virtual {v0}, Latz;->l()Lavl;

    move-result-object v3

    iget-object v4, p0, Loaw;->b:Lavh;
    ...
    .line 71
    invoke-virtual {v1, v3, v4, v5, v2}, Laux;->a(Lavl;Lavh;II)V
