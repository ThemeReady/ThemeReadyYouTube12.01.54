...
.method public final a(Landroid/content/Context;Lofl;Landroid/view/View;Landroid/view/ViewGroup;Lohn;Z)Landroid/view/View;
    ...
    .line 1125
    iget-object v0, p2, Lofl;->i:Lwyq;

    .line 35
    invoke-direct {v9, v0}, Lofv;-><init>(Lwyq;)V
    ...
    iput-object v2, v4, Logc;->a:Landroid/widget/TextView;

    .line 50
    new-instance v2, Ljava/util/ArrayList;

    .line 2127
    iget-object v5, v9, Lofv;->a:Ljava/util/List;
    ...
    iput-object v2, v4, Logc;->c:Ljava/util/ArrayList;
    ...
    iput-object v2, v4, Logc;->b:Landroid/view/ViewGroup;
    ...
    .line 57
    :goto_1
    iget-object v0, v8, Logc;->a:Landroid/widget/TextView;

    invoke-virtual {v9}, Lofv;->a()Ljava/lang/CharSequence;
    ...
    .line 4127
    iget-object v4, v9, Lofv;->a:Ljava/util/List;
...
.method final a(Landroid/view/ViewGroup;Landroid/content/Context;Landroid/view/LayoutInflater;Lohn;Ljava/util/List;ZLohr;)V
    .locals 16
    ...
    invoke-direct/range {v2 .. v9}, Lofy;-><init>(Lofx;Landroid/content/Context;Lohn;Landroid/view/ViewGroup;Landroid/view/LayoutInflater;Ljava/util/List;Z)V
    ...
    .line 103
    iget-object v4, v3, Logc;->c:Ljava/util/ArrayList;
    ...
    .line 5036
    iget-object v11, v4, Lofw;->a:Lwyo;

    invoke-virtual {v11}, Lwyo;->gP_()Landroid/text/Spanned;

    move-result-object v11

    .line 4142
    invoke-static {v6, v11}, Lmvf;->a(Landroid/widget/TextView;Ljava/lang/CharSequence;)V

    .line 6032
    iget-object v11, v4, Lofw;->b:Lofv;

    .line 6131
    iget-boolean v11, v11, Lofv;->b:Z
    ...
    .line 4150
    invoke-static {v7, v12}, Lmvf;->a(Landroid/widget/TextView;Ljava/lang/CharSequence;)V
    ...
    .line 7040
    :goto_2
    iget-object v8, v4, Lofw;->a:Lwyo;

    iget-boolean v8, v8, Lwyo;->c:Z
    ...
    invoke-direct {v5, v0, v4, v2}, Loga;-><init>(Lohn;Lofw;Ljava/lang/Runnable;)V
    ...
    .line 111
    iget-object v5, v3, Logc;->c:Ljava/util/ArrayList;

    invoke-virtual {v5, v4}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 112
    iget-object v5, v3, Logc;->b:Landroid/view/ViewGroup;
    ...
    iget-object v13, v0, Lohr;->a:Ljava/util/Collection;

    new-instance v14, Lohs;

    invoke-direct {v14, v8, v11, v12}, Lohs;-><init>(Landroid/widget/ProgressBar;FF)V
    ...
    :cond_5
    :goto_5
    iget-object v2, v3, Logc;->c:Ljava/util/ArrayList;
