...
# direct methods
.method private constructor <init>(Ljava/security/Key;Lhut;Ltzb;Lmwf;Lmkb;Lroy;)V
    .locals 3

    .prologue
    .line 64
    invoke-direct {p0, p1, p2, p3}, Ltzc;-><init>(Ljava/security/Key;Lhut;Ltzb;)V
    ...
    invoke-direct {v1, p4, p5, p6}, Lsox;-><init>(Lmwf;Lmkb;Lroy;)V

    .line 1152
    iget-object v2, p0, Ltzc;->c:Lorg/apache/http/protocol/HttpRequestHandlerRegistry;
...
.method public static a(Ljava/security/Key;Lhut;Ltzb;Lmwf;Lmkb;Lroy;)Lsok;
    .locals 8
    ...
    invoke-direct/range {v0 .. v6}, Lsok;-><init>(Ljava/security/Key;Lhut;Ltzb;Lmwf;Lmkb;Lroy;)V
    ...
    iput-object v1, v0, Ltzc;->e:Ljava/net/ServerSocket;
    ...
    .line 1146
    iget-object v2, v0, Ltzc;->e:Ljava/net/ServerSocket;
    ...
    iput-object v1, v0, Ltzc;->f:Ljava/util/concurrent/ExecutorService;

    .line 1148
    iget-object v1, v0, Ltzc;->f:Ljava/util/concurrent/ExecutorService;

    new-instance v2, Ltzd;

    invoke-direct {v2, v0}, Ltzd;-><init>(Ltzc;)V
...
.method public final a(Ljava/lang/String;ILjava/lang/String;JJJ)Landroid/net/Uri;
    ...
    invoke-virtual/range {v3 .. v11}, Lsok;->a(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;JJ)Ltze;
    ...
    invoke-virtual {v2, v3, v0, v1}, Ltze;->a(Ljava/lang/String;J)Ltze;

    move-result-object v2

    .line 82
    invoke-virtual {v2}, Ltze;->a()Landroid/net/Uri;
