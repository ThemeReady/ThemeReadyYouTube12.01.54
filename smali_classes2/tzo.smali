...
.method constructor <init>(Ljava/security/Key;)V
    ...
    .line 28
    iput-object p1, p0, Ltzo;->a:Ljava/security/Key;
...
.method protected final a(Landroid/net/Uri;Lorg/apache/http/Header;Lorg/apache/http/HttpResponse;)V
    ...
    .line 47
    invoke-virtual {v4, p3}, Ltza;->a(Lorg/apache/http/HttpResponse;)Z
    ...
    iget-wide v2, v4, Ltza;->a:J

    iget-wide v4, v4, Ltza;->b:J

    iget-object v6, p0, Ltzo;->a:Ljava/security/Key;

    invoke-direct/range {v0 .. v6}, Ltzm;-><init>(Ljava/io/File;JJLjava/security/Key;)V
