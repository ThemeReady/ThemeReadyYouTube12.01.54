...
.field private k:Lyvv;


# direct methods
.method public constructor <init>(Lyvp;Lcom/google/android/libraries/youtube/proto/nano/InnerTubeUploadsConfig;Lpio;Landroid/os/Handler;Lyvu;Lywc;)V
    .locals 3
    ...
    iput-object v0, p0, Lyso;->f:Ljava/util/Map;
    ...
    iput-object v0, p0, Lyso;->g:Ljava/util/Map;
    ...
    iput-object v0, p0, Lyso;->h:Ljava/util/Map;
    ...
    iput-object v0, p0, Lyso;->i:Ljava/util/Map;

    .line 47
    new-instance v0, Lysp;

    invoke-direct {v0, p0}, Lysp;-><init>(Lyso;)V

    iput-object v0, p0, Lyso;->j:Lpil;
    ...
    iput-object v0, p0, Lyso;->a:Lcom/google/android/libraries/youtube/proto/nano/InnerTubeUploadsConfig;
    ...
    invoke-direct {v0, p3, v1, v2, p4}, Lpib;-><init>(Lpio;ZZLandroid/os/Handler;)V

    iput-object v0, p0, Lyso;->d:Lpib;

    .line 107
    iget-object v0, p0, Lyso;->d:Lpib;
    ...
    iget-object v1, p0, Lyso;->j:Lpil;

    invoke-virtual {v0, v1}, Lpib;->a(Lpil;)V
...
.method private final declared-synchronized a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZJ)V
    ...
    .line 206
    iget-object v0, p0, Lyso;->f:Ljava/util/Map;
    ...
    iget-object v3, p0, Lyso;->g:Ljava/util/Map;
    ...
    .line 208
    iget-object v0, p0, Lyso;->h:Ljava/util/Map;

    invoke-interface {v0}, Ljava/util/Map;->size()I

    move-result v0

    iget-object v3, p0, Lyso;->i:Ljava/util/Map;
    ...
    .line 216
    iget-object v0, p0, Lyso;->i:Ljava/util/Map;
    ...
    invoke-virtual {v0, p3}, Lpib;->a(Ljava/lang/String;)V
    :try_end_0
    ...
    .line 223
    iget-object v0, p0, Lyso;->g:Ljava/util/Map;
    ...
    .line 228
    :goto_8
    iget-object v2, p0, Lyso;->d:Lpib;

    invoke-virtual {v2, p2, p4, v0, v1}, Lpib;->a(Ljava/lang/String;Ljava/lang/String;J)V
    :try_end_1
...
.method private final declared-synchronized c()V
    ...
    :try_start_0
    iget-object v0, p0, Lyso;->e:Lyvu;

    iget-object v1, p0, Lyso;->k:Lyvv;

    invoke-interface {v0, v1}, Lyvu;->a(Lyvv;)V

    .line 348
    invoke-virtual {p0}, Lyso;->b()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private final declared-synchronized d()V
    ...
    invoke-interface {v0, v1}, Lyvu;->b(Lyvv;)V
...
.method final declared-synchronized a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 302
    iget-object v1, p0, Lyso;->h:Ljava/util/Map;
    ...
    iget-object v4, p0, Lyso;->i:Ljava/util/Map;
    ...
    .line 314
    :goto_3
    iget-object v1, p0, Lyso;->f:Ljava/util/Map;
    ...
    :cond_1
    :try_start_1
    iget-object v1, p0, Lyso;->c:Lyvp;

    new-instance v2, Lyst;

    invoke-direct {v2, p0}, Lyst;-><init>(Lyso;)V

    invoke-virtual {v1, v0, v2}, Lyvp;->a(Ljava/lang/String;Lyvj;)Lyvd;
    :try_end_1
    ...
    iget-object v4, p0, Lyso;->g:Ljava/util/Map;
...
.method final declared-synchronized a(Ljava/lang/String;Ljava/lang/String;Lxso;)V
    .locals 3
    ...
    .line 266
    invoke-direct {p0, p1, p2}, Lyso;->b(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 269
    :try_start_1
    iget-object v0, p0, Lyso;->c:Lyvp;

    new-instance v1, Lyss;

    invoke-direct {v1, p3}, Lyss;-><init>(Lxso;)V

    invoke-virtual {v0, v2, v1}, Lyvp;->a(Ljava/lang/String;Lyvj;)Lyvd;
    :try_end_1
    .catch Lyvi; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method final declared-synchronized a(Ljava/lang/String;Ljava/lang/String;Lxud;)V
    .locals 3
    ...
    invoke-direct {v1, p3}, Lysr;-><init>(Lxud;)V
...
.method public final declared-synchronized a(Ljava/lang/String;Lyvd;)Z
    .locals 10
    ...
    invoke-virtual {v0, p1}, Lyvp;->a(Ljava/lang/String;)Ljava/lang/Comparable;
    ...
    invoke-static {v4}, Lyta;->b(Lcom/google/android/libraries/youtube/upload/service/proto/nano/UploadProto$UploadJobProto$State;)Z
    ...
    invoke-static {v1}, Lyta;->d(Lcom/google/android/libraries/youtube/upload/service/proto/nano/UploadProto$UploadJobProto$State;)J
    ...
    invoke-direct/range {v0 .. v7}, Lyso;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZJ)V
    :try_end_2
    .catch Lyvi; {:try_start_2 .. :try_end_2} :catch_0
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
