...
.method private constructor <init>(Landroid/content/Context;Landroid/net/Uri;Ljava/io/File;III)V
    ...
    .line 76
    iput-object p2, p0, Lywk;->b:Landroid/net/Uri;

    .line 77
    iput-object p3, p0, Lywk;->c:Ljava/io/File;
...
.method public static a(Landroid/content/Context;Landroid/net/Uri;JLjava/io/File;Lywh;)Lywk;
    .locals 12
    ...
    invoke-static/range {v1 .. v7}, Lypi;->a(Ljava/io/InputStream;JZZZLypj;)Lypk;

    move-result-object v0

    .line 2086
    sget-object v1, Lypk;->k:Lypk;
    ...
    .line 2090
    iget-object v0, v7, Lypj;->b:Lyot;

    const-string v2, "trak"

    invoke-virtual {v0, v2}, Lyot;->a(Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {v0, v3}, Lyot;->a(Ljava/lang/String;)Ljava/util/List;
    ...
    .line 3032
    iget-object v0, v0, Lyot;->a:Lyox;

    .line 3110
    iget-object v0, v0, Lyox;->c:[B
    ...
    invoke-direct {v0, v1}, Lywk;-><init>(I)V
    ...
    .line 105
    invoke-static/range {v1 .. v7}, Lywk;->a(Landroid/content/Context;Landroid/net/Uri;Landroid/media/MediaExtractor;JLjava/io/File;Lywh;)Lywk;
...
.method private static a(Landroid/content/Context;Landroid/net/Uri;Landroid/media/MediaExtractor;JLjava/io/File;Lywh;)Lywk;
    .locals 17
    ...
    invoke-direct {v2, v3}, Lywk;-><init>(I)V
    ...
    .line 149
    :cond_5
    invoke-static/range {p2 .. p2}, Lzyo;->a(Landroid/media/MediaExtractor;)Lzyp;

    move-result-object v2

    .line 151
    iget-object v3, v2, Lzyp;->b:Landroid/media/MediaFormat;
    ...
    .line 163
    iget-object v2, v2, Lzyp;->b:Landroid/media/MediaFormat;
    ...
    invoke-static {v8, v9}, Lywk;->a(D)I
    ...
    invoke-static {v2, v3}, Lywk;->a(D)I
    ...
    invoke-direct/range {v2 .. v8}, Lywk;-><init>(Landroid/content/Context;Landroid/net/Uri;Ljava/io/File;III)V
